...
const unsigned char AzureIoTADURootKeyId[13] = "ADU.200702.R";
const unsigned char AzureIoTADURootKeyN[385] = { 0x00, 0xd5, 0x42, 0x2e, 0xaf, 0x11, 0x54, 0xa3, 0x50, 0x65, 0x87, 0xa2, 0x4d, 0x5b, 0xba,
...
const unsigned char AzureIoTADURootKeyE[3] = { 0x01, 0x00, 0x01 };
