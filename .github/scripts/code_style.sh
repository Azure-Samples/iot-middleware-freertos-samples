...
if [[ "$FIX" == "check" ]]; then
    ...
    ./demos/projects/ESPRESSIF/az-ca-recovery/components/sample-azure-iot-ca-recovery/*.c \
    ./demos/projects/ESPRESSIF/az-nvs-cert-bundle/main/*.c                                \
