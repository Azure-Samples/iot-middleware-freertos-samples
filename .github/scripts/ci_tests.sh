...
do
    case "$arg" in
        "-esp")
            ...
            sample_build "ESPRESSIF" "ca-recovery" "build" "Debug"
            exit_if_binary_does_not_exist "./demos/projects/ESPRESSIF/ca-recovery/build" "azure_iot_freertos_esp32.bin"
            ...
            exit_if_binary_does_not_exist "./demos/projects/ESPRESSIF/adu/build" "azure_iot_freertos_esp32.bin"
            sample_build "ESPRESSIF" "ca-recovery" "build" "Release"
            exit_if_binary_does_not_exist "./demos/projects/ESPRESSIF/ca-recovery/build" "azure_iot_freertos_esp32.bin"
