if(NOT Mbedtls_PATH)
    set(Mbedtls_PATH /opt/Mbedtls CACHE PATH "Path to Mbedtls")
    message(STATUS "No Mbedtls_PATH specified using default: ${Mbedtls_PATH}")
endif()

list(APPEND Mbedtls_INCLUDE_DIRS "${FreeRTOS_COMMON_INCLUDE}")
