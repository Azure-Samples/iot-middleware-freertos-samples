...
const char* three_way_vacuum_release_valve_before_condenser_stringified[] = {
    "three_way_vacuum_release_valve_before_condenser_to_TANK",        // 0
    "three_way_vacuum_release_valve_before_condenser_to_AIR"          // 1
};
